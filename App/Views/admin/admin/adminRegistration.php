<section id="admin-registration">
    ...
    <div class="row main-container">
        ...
        <h5 class="col-11 mx-auto mb-4 mt-3 p-0">Cadastrar administrador</h5>

        <div class="card col-lg-11 col-11 mx-auto mb-4" id="admin-record-accordion">
            ...
            <div class="registration-in-stages mb-2 accordion">
                ...
                <div class="registration-header-by-step mt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="container-option">
                            ...
                            <a type="button" class="" data-toggle="collapse" data-target="#admin-registration-initial-data"><span>1</span></a>
                        ...
                        <div class="container-option">
                            ...
                            <a type="button" class="collapsed" data-toggle="collapse" data-target="#admin-registration-address-and-others"><span>2</span></a>
                        ...
                        <div class="container-option">
                            ...
                            <a type="button" class="collapsed" data-toggle="collapse" data-target="#admin-registration-finishing"><span>3</span></a>
                ...
                <form class="mt-3" id="addAdmin" role="form" enctype="multipart/form-data" method="POST">

                    <div class="row collapse show" id="admin-registration-initial-data" data-parent="#admin-record-accordion">
                        <div class="col-lg-11 mx-auto">
                            <div class="col-md-12">
                                <div class="form-row mt-2">
                                    ...
                                    <div id="biField" class="form-group col-md-4">
                                        <label for="bi">BI:</label>
                                        <input type="text" id="bi" value="" minlength="14" name="bi" class="form-control" placeholder="" required>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-12 d-flex justify-content-end">
                                        <a type="button" data-toggle="collapse" data-target="#admin-registration-address-and-others" class="btn text-white mt-2 collapsed" href="">Proximo <i class="fas fa-angle-right"></i></a>
                                    </div>
                    ...
                    <div class="row collapse" id="admin-registration-address-and-others" data-parent="#admin-record-accordion">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row d-flex justify-content-end">
                                    ...
                                    <div class="form-group mr-2">
                                        <a type="button" data-toggle="collapse" data-target="#admin-registration-initial-data" class="btn bg-secondary text-white mt-2 collapsed" href=""><i class="fas fa-angle-left mr-3"></i> Voltar</a>
                                    </div>

                                    <div class="form-group">
                                        <a type="button" class="collapsed btn text-white mt-2 collapsed" data-toggle="collapse" data-target="#admin-registration-finishing" href="">Proximo <i class="fas fa-angle-right ml-3"></i></a>
                                    </div>
                    ...
                    <div class="row collapse" id="admin-registration-finishing" data-parent="#admin-record-accordion">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-11 mx-auto p-0">
                                    ...
                                    <div class="row d-flex justify-content-between">
                                        ...
                                        <a type="button" data-toggle="collapse" data-target="#admin-registration-address-and-others" class="btn bg-secondary text-white collapsed ml-3" href=""><i class="fas fa-angle-left mr-3"></i> Voltar</a>

                                        <button id="buttonAddAdmin" disabled class="btn btn-success">Cadastrar docente</button>
