                    ...
                    <div class="row p-3 main-sheet">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <span class="col-12 mx-auto"><?= $this->view->classData[0]->series_acronym ?>ª <?= $this->view->classData[0]->ballot ?> <?= $this->view->classData[0]->course ?> <?= $this->view->classData[0]->shift ?> - Ano Letivo <?= $this->view->classData[0]->school_term ?></span>
