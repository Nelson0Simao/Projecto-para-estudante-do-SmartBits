                        ...
                        <div class="row">
                            ...
                            <form id="teacherModal<?= $teacher->id ?>" class="col-lg-12" action="">
                                ...
                                <div class="input-group d-flex justify-content-start col-lg-9 flex-nowrap">
                                    ...
                                    <input type="text" onload="this.value = this.value.mask('000.000.000-00')" id="bi" name="bi" disabled class="form-control" value="<?= $teacher->bi ?>" aria-label="Username" aria-describedby="addon-wrapping">
                                </div>
