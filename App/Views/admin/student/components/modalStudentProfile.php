                    ...
                    <div class="row">
                        ...
                        <?php if (isset($_SESSION['Admin']) && $_SESSION['Admin']['hierarchyFunction'] <= 2) { ?>
                            ...
                            <div class="input-group d-flex justify-content-start col-lg-11 flex-nowrap">
                                ...
                                <input type="text" onload="this.value = this.value.mask('000.000.000-00')" id="bi" name="bi" disabled class="form-control" value="<?= $student->bi ?>" aria-label="Username" aria-describedby="addon-wrapping">
                            </div>
