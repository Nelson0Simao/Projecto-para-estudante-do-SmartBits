                    ...
                    <div class="col-lg-11 mx-auto collapse show" id="accordion-data-admin" data-parent="#main-accordion">
                        ...
                        <form id="adminDate<?= $teacher->id ?>" class="col-lg-12" action="">
                            ...
                            <div class="input-group d-flex justify-content-start col-lg-11 flex-nowrap">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="addon-wrapping">BI:</span>
                                </div>
                                <input type="text" onload="this.value = this.value.mask('000.000.000-00')" id="bi" name="bi" disabled class="form-control" value="<?= $teacher->bi ?>" aria-label="Username" aria-describedby="addon-wrapping" style="pointer-events:none">
                            </div>
